 ...
 *   3. OpenAI   (models: gpt-4o-mini              -> gpt-3.5-turbo-16k)
 *
 ...
 * so you don't need all configured keys — it works with one provider,
 * but gets more resilient the more you add.
 */
...
const PROVIDERS: ProviderConfig[] = [
  ...
  },
  {
    ...
    models: ["gpt-4o-mini", "gpt-3.5-turbo-16k"],
    call: callOpenAI,
  },
];
