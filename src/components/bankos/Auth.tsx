...
export function Auth() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      ...
      // No full page reload here — that was the cause of the landing page
      // flashing for a second before the dashboard appeared. useLogin /
      // useRegister already clear the query cache and refetch the auth
      // query, so `account` / `hasProfile` update in place and the effect
      // in page.tsx moves us straight from this screen to app/onboarding.
    } catch (err) {
